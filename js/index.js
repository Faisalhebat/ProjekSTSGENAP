function loadRiwayatKeluhan() {
  const data2 = JSON.parse(localStorage.getItem("keluhanData") || "[]"); // ✅ FIX KEY
    ...
    .map(
      ...
      <div class="riwayat-item">
        ...
        <p class="riwayat-desc">
          ${keluhan.deskripsi.substring(0, 80)}
          ${keluhan.deskripsi.length > 80 ? "..." : ""}
        </p>

        
        <p class="riwayat-tanggal">${keluhan.tanggal}</p>
      </div>
    `,
    )
    .join("");
